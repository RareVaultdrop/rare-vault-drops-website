(() => {
  ...
  function updateGate() {
    ...
    button.textContent = 'SEND FULL TEST ENTRY';
    if (gateTitle) gateTitle.textContent = 'FULL WEBSITE TEST MODE';
    if (gateCountdown) gateCountdown.textContent = 'Tests Google Sheet + Yahoo + confirmation email';
  }
